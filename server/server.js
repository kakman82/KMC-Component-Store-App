...
const pttAddressRoutes = require('./routes/api/pttAddressRoutes')
const deliveryAddressRoutes = require('./routes/api/deliveryAddressRoutes')
const billingAddressRoutes = require('./routes/api/billingAddressRoutes')
...
app.use('/api', pttAddressRoutes)
app.use('/api', deliveryAddressRoutes)
app.use('/api', billingAddressRoutes)
